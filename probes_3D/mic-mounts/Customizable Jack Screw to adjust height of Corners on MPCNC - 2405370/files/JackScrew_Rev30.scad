...
Thread_Ht = 39;                     //Height of Threads

Tot_Ht = 100;                       //Total Height of Jack Screw 
...
Nut_Trans_Ht = 4;                   //Transition height from round to 6 sided Nut
Nut_Ht = 6;                         //Height of Hex Nut
Nut_Ht2 = Nut_Ht / 2;
...
Hex_Hor_OD = 4.0;                   //Horizontal Hex dimension across Flats
